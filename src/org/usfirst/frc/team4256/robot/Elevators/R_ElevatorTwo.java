...
public class R_ElevatorTwo {
	...
	**/
	public void init() {
		master.init();
//		master.configAllowableClosedloopError(0, (int)master.convert.from.REVS.afterGears(inchesToRevs(.5)), R_Talon.kTimeoutMS);//TODO
		...
		master.config_kD(0, 2.0, R_Talon.kTimeoutMS);
	}
